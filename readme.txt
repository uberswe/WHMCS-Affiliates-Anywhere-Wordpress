=== Anveto Affiliate Anywhere for WHMCS ===
Contributors: Anveto, Markus Tenghamn
Tags: whmcs, affiliate, linking
...
1. Upload `anveto-affiliate-anywhere-whmcs` to the `/wp-content/plugins/` directory
